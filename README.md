...
● Listar reclamações registradas;

● Registrar uma nova reclamação;

● Pesquisar uma reclamação pelo código;

● Atualizar uma reclamação existente;

● Remover uma reclamação pelo código;

● Mostrar a quantidade total de reclamações cadastradas;
